...
<div class="flex items-center gap-4 text-stone-50">
	<button on:click={playPrevTrack} class="transition-colors duration-75 active:text-stone-500">
		<Icon icon="pepicons-pop:previous-track-circle" class="w-8 h-8" />
	</button>

	<button on:click={togglePlay} class="transition-colors duration-75 active:text-stone-500">
	...
	<button on:click={playNextTrack} class="transition-colors duration-75 active:text-stone-500">
		<Icon icon="pepicons-pop:next-track-circle" class="w-8 h-8" />
	</button>
</div>

<div class="flex items-center gap-8">
	<button on:click={toggleRepeat} class="transition-colors duration-75 active:text-stone-500">
	...
	<button on:click={toggleShuffle} class="transition-colors duration-75 active:text-stone-500">
